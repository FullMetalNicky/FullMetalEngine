...
/** \class PhysicalAngularFriction
*  \brief Inherits from IPhysicalForce interface. Implements angular friction.
*/
...
namespace FME
{
	...
	{
		class PhysicalAngularFriction : public IPhysicalForce
		{
		public:

			/** \brief PhysicalAngularFriction
			...
			*/
			...
			PhysicalAngularFriction(float normal, glm::vec3 frictionCoefficient);
