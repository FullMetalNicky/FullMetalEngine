...
/** \class PhysicalCustomRadialSpring
...
namespace FME
{
	...
	{
		class PhysicalCustomRadialSpring : public IPhysicalForce
		{
		public:

			/** \brief PhysicalCustomRadialSpring
			...
			*/
			...
			PhysicalCustomRadialSpring(glm::vec2 range, glm::vec2 springConstant);
